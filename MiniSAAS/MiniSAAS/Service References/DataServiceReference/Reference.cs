...
namespace MiniSAAS.DataServiceReference {
    ...
    public interface IDataService {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IDataService/GetOrgs", ReplyAction="http://tempuri.org/IDataService/GetOrgsResponse")]
        System.IAsyncResult BeginGetOrgs(System.AsyncCallback callback, object asyncState);
        
        System.Collections.ObjectModel.ObservableCollection<string> EndGetOrgs(System.IAsyncResult result);
    }
    ...
    public partial class GetOrgsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public GetOrgsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    public partial class DataServiceClient : System.ServiceModel.ClientBase<MiniSAAS.DataServiceReference.IDataService>, MiniSAAS.DataServiceReference.IDataService {
        ...
        private BeginOperationDelegate onBeginGetOrgsDelegate;
        
        private EndOperationDelegate onEndGetOrgsDelegate;
        
        private System.Threading.SendOrPostCallback onGetOrgsCompletedDelegate;
        ...
        public event System.EventHandler<GetOrgsCompletedEventArgs> GetOrgsCompleted;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult MiniSAAS.DataServiceReference.IDataService.BeginGetOrgs(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetOrgs(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Collections.ObjectModel.ObservableCollection<string> MiniSAAS.DataServiceReference.IDataService.EndGetOrgs(System.IAsyncResult result) {
            return base.Channel.EndGetOrgs(result);
        }
        
        private System.IAsyncResult OnBeginGetOrgs(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((MiniSAAS.DataServiceReference.IDataService)(this)).BeginGetOrgs(callback, asyncState);
        }
        
        private object[] OnEndGetOrgs(System.IAsyncResult result) {
            System.Collections.ObjectModel.ObservableCollection<string> retVal = ((MiniSAAS.DataServiceReference.IDataService)(this)).EndGetOrgs(result);
            return new object[] {
                    retVal};
        }
        
        private void OnGetOrgsCompleted(object state) {
            if ((this.GetOrgsCompleted != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.GetOrgsCompleted(this, new GetOrgsCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }
        
        public void GetOrgsAsync() {
            this.GetOrgsAsync(null);
        }
        
        public void GetOrgsAsync(object userState) {
            if ((this.onBeginGetOrgsDelegate == null)) {
                this.onBeginGetOrgsDelegate = new BeginOperationDelegate(this.OnBeginGetOrgs);
            }
            if ((this.onEndGetOrgsDelegate == null)) {
                this.onEndGetOrgsDelegate = new EndOperationDelegate(this.OnEndGetOrgs);
            }
            if ((this.onGetOrgsCompletedDelegate == null)) {
                this.onGetOrgsCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnGetOrgsCompleted);
            }
            base.InvokeAsync(this.onBeginGetOrgsDelegate, null, this.onEndGetOrgsDelegate, this.onGetOrgsCompletedDelegate, userState);
        }
        ...
        private class DataServiceClientChannel : ChannelBase<MiniSAAS.DataServiceReference.IDataService>, MiniSAAS.DataServiceReference.IDataService {
            ...
            public System.IAsyncResult BeginGetOrgs(System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[0];
                System.IAsyncResult _result = base.BeginInvoke("GetOrgs", _args, callback, asyncState);
                return _result;
            }
            
            public System.Collections.ObjectModel.ObservableCollection<string> EndGetOrgs(System.IAsyncResult result) {
                object[] _args = new object[0];
                System.Collections.ObjectModel.ObservableCollection<string> _result = ((System.Collections.ObjectModel.ObservableCollection<string>)(base.EndInvoke("GetOrgs", _args, result)));
                return _result;
            }
        }
    }
