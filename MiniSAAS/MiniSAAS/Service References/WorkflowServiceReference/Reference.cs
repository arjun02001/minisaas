...
namespace MiniSAAS.WorkflowServiceReference {
    ...
    public interface IWorkflowService {
        ...
        System.IAsyncResult BeginRegister(string emailid, string password, System.AsyncCallback callback, object asyncState);
    ...
    public partial class WorkflowServiceClient : System.ServiceModel.ClientBase<MiniSAAS.WorkflowServiceReference.IWorkflowService>, MiniSAAS.WorkflowServiceReference.IWorkflowService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult MiniSAAS.WorkflowServiceReference.IWorkflowService.BeginRegister(string emailid, string password, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginRegister(emailid, password, callback, asyncState);
        }
        ...
        private System.IAsyncResult OnBeginRegister(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string emailid = ((string)(inValues[0]));
            string password = ((string)(inValues[1]));
            return ((MiniSAAS.WorkflowServiceReference.IWorkflowService)(this)).BeginRegister(emailid, password, callback, asyncState);
        }
        ...
        public void RegisterAsync(string emailid, string password) {
            this.RegisterAsync(emailid, password, null);
        }
        
        public void RegisterAsync(string emailid, string password, object userState) {
        ...
        private class WorkflowServiceClientChannel : ChannelBase<MiniSAAS.WorkflowServiceReference.IWorkflowService>, MiniSAAS.WorkflowServiceReference.IWorkflowService {
            ...
            public System.IAsyncResult BeginRegister(string emailid, string password, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[2];
                _args[0] = emailid;
                _args[1] = password;
